...
def genericStateOfStrat(strategy, currency, vault):
    ...
    totalDebt = strState["totalDebt"]/  (10 ** decimals)
    debtLimit = strState["debtRatio"]/  (10 ** decimals)
    totalLosses = strState["totalLoss"]/  (10 ** decimals)
    totalReturns = strState["totalGain"]/  (10 ** decimals)
